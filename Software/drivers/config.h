...
#define DFLT_RFID_DETECT_TIMEOUT	 20	// 20s
...
typedef enum
{
    EM1_MOD_RFID,	//!<  0: The RFID Module uses the UART
    EM1_MOD_AUDIO,	//!<  1: The Audio Module uses the UART
    END_EM1_MODULES
} EM1_MODULES;
...
typedef enum
{
    ERR_SRC_AUDIO,	//!<  0: The Audio Module reports an error
    END_ERR_SRC
} ERR_SRC;
