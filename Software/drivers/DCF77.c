 ...
 *
 * @warning
 * Be aware, the DCF77 hardware module is very sensitive against high
 ...
 * necessary.  For better performance, it is recommended to connect the battery
 * ground to earth potential.
 *
 ****************************************************************************//*
Revision History:
